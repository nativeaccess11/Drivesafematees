					...
					<div className="row">
						...
						<div className="col-lg-6">
							<div className="about-us-thumb">
								...
								<Image src="/assets/imagess/img2.avif" alt="img" width={103} height={22}   />
								</div>
							</div>
						</div>
					</div>
					<div className="about2-us-shape">
						<Image src="/assets/imagess/img3.avif" alt="img" width={205} height={426}   />
					</div>
					<div className="about-us-shape2">
						<Image src="/assets/imagess/img4.avif" alt="img" width={975} height={790}   />
					</div>
				</div>
				<VideoModal
					isTrue={toggle}
